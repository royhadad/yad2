    ...
    render() {
        ...
        return (
            <div className='filter-bar__filter__wrapper'>
                ...
                <button
                    className={this.props.filters.showOnlyItemsWithPrice ? selectedButtonClassName : notSelectedButtonClassName}
                    onClick={this.props.toggleShowOnlyItemsWithPrice}
                >
                    {unicode.shekel} {filterBarResources.filterWithPriceText}
                </button>
                <button
                    className={this.props.filters.showOnlyItemsWithImage ? selectedButtonClassName : notSelectedButtonClassName}
